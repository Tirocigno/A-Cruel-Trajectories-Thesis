...
\input{src/2-mainmatter/problem/1-sec-problem.tex}

\subsection{Clustering}\label{subsec:clustering-problem}
\input{src/2-mainmatter/problem/1-subsec-clustering-problem.tex}

\subsection{Dati di traiettoria}\label{subsec:trajectorydata-problem}
\input{src/2-mainmatter/problem/1-subsec-trajectorydata-problem.tex}

\subsection{Clustering di dati di traiettoria}\label{subsec:trajectoryclustering-problem}
\input{src/2-mainmatter/problem/1-subsec-trajectoryclustering-problem.tex}
