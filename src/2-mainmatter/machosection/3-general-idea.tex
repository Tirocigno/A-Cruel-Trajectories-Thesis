...
Parlando poi di clustering di traiettorie, rispetto a quanto trattato nella nella~\cref{subsec:trajectoryclustering-problem}, è possibile aggiungere un'ulteriore divisione:
