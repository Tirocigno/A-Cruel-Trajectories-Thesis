...
\usepackage[%
  ...
  noabbrev                      %Impedisce le abbreviazioni
]{cleveref}                     % permette di usare riferimenti migliori dei \ref e dei varioref

\usepackage{booktabs}         % permette di gestire le linee sulle tabelle in alternativa alle hbox
\usepackage{mathtools}          % permette di mandare a capo le definizioni matematiche

\usepackage[Algoritmo]{algorithm}          % permette di scrivere algoritmi.
% \usepackage{algorithm2e}          % permette di scrivere algoritmi.
% \usepackage{algorithmicx}          % permette di scrivere algoritmi.
\usepackage[noend]{algpseudocode} % aggiunge il supporto allo pseudocodice.
\algnewcommand\algorithmicforeach{\textbf{for each}}
\algdef{S}[FOR]{ForEach}[1]{\algorithmicforeach\ #1\ \algorithmicdo}
\renewcommand{\algorithmicrequire}{\textbf{Richiede:}}
\renewcommand{\algorithmicensure}{\textbf{Restituisce:}}
...
\begin{document}
  ...
  \addchap{Introduzione}\label{chapter:chapter0}
  \input{src/2-mainmatter/0-introduction}


  \chapter{Problematica}\label{chapter:chapter1}
  \input{src/2-mainmatter/1-trajectory-clustering.tex}

  \chapter{Tecnologie utilizzate}\label{chapter:chapter2}
  \input{src/2-mainmatter/6-bigdatatechniques.tex}

  \chapter{Pattern di co-movimento}\label{chapter:chapter3}
  \input{src/2-mainmatter/2-gcmp-algorithm.tex}

  \chapter{Colossal Trajectory Mining}\label{chapter:chapter4}
  \input{src/2-mainmatter/3-macho-algorithm.tex}

  \chapter{Test sperimentali}\label{chapter:chapter5}
  \input{src/2-mainmatter/4-comparison-algorithm.tex}

  \chapter{Conclusioni e sviluppi futuri}\label{chapter:chapter6}
  \input{src/2-mainmatter/5-conclusion.tex}

  \addchap{Ringraziamenti}\label{chapter:chapter7}
